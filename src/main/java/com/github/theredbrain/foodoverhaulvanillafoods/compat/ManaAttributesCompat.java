...
public class ManaAttributesCompat {
	public static void addAttributes() {
		StatusEffectsRegistry.FERMENTED_SPIDER_EYE_FOOD_EFFECT
				.addAttributeModifier(ManaAttributes.MAX_MANA, FoodOverhaulVanillaFoods.identifier("effect.fermented_spider_eye_food_effect"), 10.0F, AttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.RED_MUSHROOM_FOOD_EFFECT
				.addAttributeModifier(ManaAttributes.MAX_MANA, FoodOverhaulVanillaFoods.identifier("effect.red_mushroom_food_effect"), 5.0F, AttributeModifier.Operation.ADD_VALUE)
		;
