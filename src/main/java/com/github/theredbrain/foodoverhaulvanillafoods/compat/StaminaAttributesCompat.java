...
//		;
		StatusEffectsRegistry.BAKED_POTATO_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.baked_potato_food_effect"), 7.0F, AttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.BEETROOT_SOUP_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.beetroot_soup_food_effect"), 10.0F, AttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.BREAD_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.bread_food_effect"), 10.0F, AttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.CAKE_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.cake_food_effect"), 25.0F, AttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.CARROT_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.carrot_food_effect"), 5.0F, AttributeModifier.Operation.ADD_VALUE)
...
//				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.cocoa_beans_food_effect"), 3.0F, EntityAttributeModifier.Operation.ADD_VALUE)
				.addAttributeModifier(StaminaAttributes.STAMINA_REGENERATION, FoodOverhaulVanillaFoods.identifier("effect.cocoa_beans_food_effect"), 2.0F, AttributeModifier.Operation.ADD_VALUE)
		;
...
//				.addAttributeModifier(StaminaAttributes.STAMINA_REGENERATION, FoodOverhaulVanillaFoods.identifier("effect.cooked_chicken_food_effect"), 3.0F, EntityAttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.COOKED_COD_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.cooked_cod_food_effect"), 10.0F, AttributeModifier.Operation.ADD_VALUE)
...
//				.addAttributeModifier(StaminaAttributes.STAMINA_REGENERATION, FoodOverhaulVanillaFoods.identifier("effect.cooked_rabbit_food_effect"), 3.0F, EntityAttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.COOKED_SALMON_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.cooked_salmon_food_effect"), 10.0F, AttributeModifier.Operation.ADD_VALUE)
//				.addAttributeModifier(StaminaAttributes.STAMINA_REGENERATION, FoodOverhaulVanillaFoods.identifier("effect.cooked_salmon_food_effect"), 3.0F, EntityAttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.COOKIE_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.cookie_food_effect"), 10.0F, AttributeModifier.Operation.ADD_VALUE)
				.addAttributeModifier(StaminaAttributes.STAMINA_REGENERATION, FoodOverhaulVanillaFoods.identifier("effect.cookie_food_effect"), 3.0F, AttributeModifier.Operation.ADD_VALUE)
		;
		...
		StatusEffectsRegistry.ENCHANTED_GOLDEN_APPLE_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.enchanted_golden_apple_food_effect"), 30.0F, AttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.GLOW_BERRIES_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.glow_berries_food_effect"), 5.0F, AttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.GOLDEN_APPLE_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.golden_apple_food_effect"), 50.0F, AttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.GOLDEN_CARROT_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.golden_carrot_food_effect"), 50.0F, AttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.MELON_SLICE_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.melon_slice_food_effect"), 3.0F, AttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.PUMPKIN_PIE_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.pumpkin_pie_food_effect"), 15.0F, AttributeModifier.Operation.ADD_VALUE)
				.addAttributeModifier(StaminaAttributes.STAMINA_REGENERATION, FoodOverhaulVanillaFoods.identifier("effect.pumpkin_pie_food_effect"), 3.0F, AttributeModifier.Operation.ADD_VALUE)
		;
		...
		StatusEffectsRegistry.RABBIT_STEW_FOOD_EFFECT
				.addAttributeModifier(StaminaAttributes.MAX_STAMINA, FoodOverhaulVanillaFoods.identifier("effect.rabbit_stew_food_effect"), 7.0F, AttributeModifier.Operation.ADD_VALUE)
		...
		StatusEffectsRegistry.SUGAR_FOOD_EFFECT
				...
				.addAttributeModifier(StaminaAttributes.STAMINA_REGENERATION, FoodOverhaulVanillaFoods.identifier("effect.sugar_food_effect"), 4.0F, AttributeModifier.Operation.ADD_VALUE)
		;
